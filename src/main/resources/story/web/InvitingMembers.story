...
Given request body: "email":${email}

When I send HTTP POST to the relative URL '/1/boards/${boardId}/members?key=f95526f030cfb910d5481bfa7d17cd1d&token=e3dc236292ba4f45c52eb58b01713ad4393dcab3ac1ce6bcd88edf19a985fa52&email=email'
Then the response code is equal to '200'
